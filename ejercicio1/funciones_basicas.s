...
---------------------------------------------------- PINTAR RECTÁNGULO ---------------------------------------------------
  ...
  X3 y X4 pueden ver como las coordenadas x_2 e y_2 de otro punto en el mismo eje. De cierta manera, puede visualizarse un 
  rectángulo con solo dos puntos:
                            (x_1,y_1)-------------------------     
...
---------------------------------------------------- PINTAR CÍRCULO ---------------------------------------------------
  ...
  función no pinte todo el cuadrado itera sobre cada pixel dentro de este calculando si está o no dentro del círculo 
  usando la siguiente ecuación:
                                        (x - x_0)² + (y - y_0)² <= r²
  Para representar a esta ecuación se utilizan un conjunto de registros auxiliares para facilitar los cálculos.
*/
.globl pintar_circulo
pintar_circulo:
